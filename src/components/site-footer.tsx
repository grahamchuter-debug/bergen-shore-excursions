...
const planYourVisitLinks = [
  ...
  { label: "Best Time to Visit Bergen", href: "/best-time-to-visit-bergen" },
...
const cruiseToolsLinks = [
  ...
  { label: "Best of Bergen Funicular", href: "/excursions/bergen-funicular-railway" },
  ...
  { label: "Private Sightseeing", href: "/excursions/private-bergen-sightseeing" },
] as const;

const whyBookWithUs = [
  "Cruise passenger friendly",
  "Return to ship timing guidance",
  "Bergen fjord and city specialists",
] as const;

const trustBullets = [
  "Return-to-ship friendly itineraries",
  "Cruise passenger focused guides",
  "Bryggen, fjord, and Fløyen planning",
] as const;
      ...
      <section className="border-t border-white/10 bg-navy text-white">
        <div className="mx-auto max-w-3xl px-4 py-10 text-center sm:px-6 sm:py-12">
          <h2 className="text-xl font-bold sm:text-2xl">
            Ready to plan your Bergen cruise day?
          </h2>
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-6 text-white/80 sm:text-base">
            ...
            specifically for cruise passengers visiting Bergen.
          </p>
          <Link
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-12 lg:gap-10">
            <div className="lg:col-span-4">
              ...
              <p className="mt-3 max-w-sm text-sm leading-6 text-white/65">
                Independent Bergen cruise port guides and shore excursion
                planning for passengers visiting Bryggen, the fjords, and
                Norway&apos;s gateway city.
              </p>
