...
export default function IsBergenWorthVisitingPage() {
  return (
    <ContentPage
      ...
      lead="An honest look at whether Bergen deserves your hours ashore — fjord drama, walkable Bryggen culture, and what cruise passengers gain on different port lengths."
    ...
    >
      <section>
        ...
        <p>
          ...
          Norwegian coast. You get a real city — restaurants, museums, harbour
          life — plus quick access to fjord scenery that rivals anywhere in
          Norway. For most guests, going ashore is worthwhile.
        </p>
      </section>
