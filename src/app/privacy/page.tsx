...
export const metadata: Metadata = buildPageMetadata({
  ...
  description:
    "Privacy policy for Bergen Shore Excursions: how this independent cruise planning website handles information.",
  path: "/privacy",
});
...
export default function PrivacyPage() {
  return (
    <ContentPage
      title="Privacy Policy"
      lead="This privacy notice describes Bergen Shore Excursions as it operates today: an informational cruise planning site without live booking or payment processing."
    ...
    >
      <section>
        ...
        <p>
          ...
          {siteConfig.url}. It provides independent Bergen cruise-port planning
          information.
        </p>
      </section>
