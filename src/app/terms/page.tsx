...
export const metadata: Metadata = buildPageMetadata({
  title: "Terms of Use",
  description:
    "Terms of use for Bergen Shore Excursions: independent cruise planning information for Bergen port days.",
  path: "/terms",
});
...
export default function TermsPage() {
  return (
    <ContentPage
      title="Terms of Use"
      lead="These terms cover use of the Bergen Shore Excursions website as an independent informational planning resource."
      ...
      ctaTitle="Plan your Bergen cruise day"
      ctaText="Explore portside options and schedules, then verify timings with your cruise line."
      ctaHref="/excursions"
    ...
    >
      <section>
        ...
        <p>
          ...
          information about Bergen. It is not a substitute for official cruise-line
